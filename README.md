...
The latest version of the library is `1.4.2`, which can be loaded and initialised on required pages like this:
...
<script type="text/javascript" src="https://cdn.runcardigan.com/cardigan-js/1.4.2/cardigan.js"></script>
```
...
```shell
npm install runcardigan/cardigan-js#1.4.2
```

or Yarn:

```shell
yarn add runcardigan/cardigan-js#1.4.2
```
