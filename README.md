...
The latest version of the library is `1.8.0`, which can be loaded and initialised on required pages like this:
...
<script type="text/javascript" src="https://cdn.runcardigan.com/cardigan-js/1.8.0/cardigan.js"></script>
```
...
```shell
npm install runcardigan/cardigan-js#1.8.0
```

or Yarn:

```shell
yarn add runcardigan/cardigan-js#1.8.0
```
...
cardigan.api.getShopConfig({
  onSuccess: (result) => {
    ...
    //     "cardigan_js_uri": "https://cdn.runcardigan.com/cardigan-js/1.8.0/cardigan.js",
    //     "endpoint": "https://app.runcardigan.com/api/v1",
    //     "matching": {
